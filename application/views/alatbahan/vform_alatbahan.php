                    ...
                    <div class="card">
                        <div class="col-sm-12">
                            <div class="content-header">
                                ...
                                ?>
                                <!-- select -->
                                <form method="post" action="<?= base_url('C_alatbahan/simpan_alatbahan') ?>"
                                    class="form-horizontal">
                                    <div class="form-group row">
                                        <label for="nama" class="col-sm-2 col-form-label">Nama Alat & Bahan</label>
                                        <div class="col-sm-10">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" name="harga_per_unit" class="form-control"
                                                id="harga_per_unit" placeholder="Harga" required>
                                        </div>
                                    </div>
